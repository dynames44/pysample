# 딕셔너리 생성 및 선언
listData = []
dictData1 = {'seqId':'001', 'name' : 'name001', 'phoneNo' : '010-1010-0001'} #javascript Json 생성과 동일 
...
print("test Data Get Default::", dictData3.get("test","nope")) #딕셔너리에 해당 키가 없을때 : 기본값 설정 Isnull, isEmpty 같은 함수 따로 만들지 말고 ..그냥쓰면 된다.
print()
...
# 딕셔너리 활용  #2
print("딕셔너리 활용 #2 --------------------------------------------")
dictData5 = dictData3.copy() 
dictKeys = dictData5.keys() #딕셔너리 Key 반환
dictValues = dictData5.values() # 딕셔너리 Value 반환
dictItems = dictData5.items() #딕셔너리 Key,Value 반환
