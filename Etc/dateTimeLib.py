...
# 전체 기간을 *년 *개월 *일 형식으로 산정할 사용자 module 추가 
from module import dateModule as dm

print(dm.get_date_diff_ymd("2024-01-22", "2025-02-28"))

# 날짜 기분 더하기 빼기 
print("start 2일 후::::::", start.add(days=2).to_date_string())
print("start 2일 전::::::", start.add(days=-2).to_date_string())
print("start 2일 전::::::", start.subtract(days=2).to_date_string())